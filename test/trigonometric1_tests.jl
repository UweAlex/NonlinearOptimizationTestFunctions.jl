# test/trigonometric1_tests.jl

using Test, NonlinearOptimizationTestFunctions
@testset "trigonometric1" begin
    tf = TRIGONOMETRIC1_FUNCTION
    @test tf.meta[:name] == "trigonometric1"  # Hartkodiert [RULE_NAME_CONSISTENCY]
    ...
    @test tf.f(min_pos_1) ≈ 0.0 atol=1e-8
end