...
@testset "Levy Tests" begin
    ...
    @test levy(tf.meta[:min_position](n)) ≈ tf.meta[:min_value](n) atol=1e-6
    ...
    @test Set(tf.meta[:properties]) == Set(["differentiable", "non-convex", "scalable", "multimodal", "bounded", "continuous", "separable"])
