...
const DEVILLIERSGLASSER2_FUNCTION = TestFunction(
    ...
    Dict{Symbol,Any}(
        ...
        :start => () -> [10.0, 10.0, 10.0, 10.0, 10.0],   # Korrektur: Alle Komponenten ≥ 1.0 (innerhalb [1.0, 60.0])
        :min_position => () -> [53.81, 1.27, 3.012, 2.13, 0.507],
        :min_value => () -> 0.0,
        :properties => Set(["bounded", "continuous", "differentiable", "multimodal", "non-separable"]),
