...
const ALPINEN2_FUNCTION = TestFunction(
    ...
    Dict{Symbol,Any}(
        ...
        :default_n => 2,
        :properties => ["bounded", "continuous", "differentiable", "multimodal", "non-convex", "scalable", "separable"],  # FIXED: Added "continuous" (required by "differentiable"), alphabetically sorted
