...
function schwefel221(x::AbstractVector{T}) where {T<:Union{Real, ForwardDiff.Dual}}
    ...
    n < 1 && throw(ArgumentError("schwefel221 requires at least 1 dimension"))  # Dynamisch [RULE_ERROR_TEXT_DYNAMIC]
...
const SCHWEFEL221_FUNCTION = TestFunction(
    ...
    Dict(
        :name => "schwefel221",  # Dynamisch: "schwefel221" [RULE_NAME_CONSISTENCY]
