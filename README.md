...
- **Ackley**: Multimodal, non-convex, differentiable, separable, scalable. Minimum: 0.0 at (0, ..., 0). Bounds: [-32.768, 32.768]^n. Dimensions: Any n.
...
- **Beale**: Multimodal, differentiable, non-convex, non-scalable. Minimum: 0.0 at (3.0, 0.5). Bounds: [-4.5, 4.5]^2. Dimensions: n=2.
- **Bohachevsky**: Multimodal, differentiable, non-convex, non-scalable. Minimum: 0.0 at (0, 0). Bounds: [-100, 100]^2. Dimensions: n=2.
- **Branin**: Multimodal, differentiable, non-convex, non-scalable. Minimum: 0.397887 at (-π, 12.275), (π, 2.275), (9.42478, 2.475). Bounds: [-5, 10] × [0, 15]. Dimensions: n=2.
- **Bukin6**: Multimodal, differentiable, non-convex, non-separable, non-scalable. Minimum: 0.0 at (-10, 1). Bounds: [-15, -5] × [-3, 3]. Dimensions: n=2.
- **DixonPrice**: Unimodal, non-convex, differentiable, scalable. Minimum: 0.0 at (2^(-1 + 1/2^1), 2^(-1 + 1/2^2), ..., 2^(-1 + 1/2^n)). Bounds: [-10, 10]^n. Dimensions: Any n.
- **Easom**: Unimodal, differentiable, non-scalable. Minimum: -1.0 at (π, π). Bounds: [-100, 100]^2. Dimensions: n=2.
- **GoldsteinPrice**: Multimodal, differentiable, non-convex, non-scalable. Minimum: 3.0 at (0, -1). Bounds: [-2, 2]^2. Dimensions: n=2.
- **Griewank**: Multimodal, non-convex, differentiable, scalable. Minimum: 0.0 at (0, ..., 0). Bounds: [-600, 600]^n. Dimensions: Any n.
- **Hartmann**: Multimodal, differentiable, non-convex, non-scalable. Minimum: -3.862782 for n=3 at (0.114614, 0.555649, 0.852547); -3.322368 for n=6 at (0.20169, 0.150011, 0.476874, 0.275332, 0.311652, 0.6573). Bounds: [0, 1]^n. Dimensions: n=3 or n=6.
- **Himmelblau**: Multimodal, differentiable, non-convex, non-scalable. Minimum: 0.0 at (3.0, 2.0), (-2.805118, 3.131312), (-3.779310, -3.283186), (3.584428, -1.848126). Bounds: [-5, 5]^2. Dimensions: n=2.
- **Langermann**: Multimodal, differentiable, non-convex, non-scalable. Minimum: approximately -5.1621259 at (2.002992, 1.006096). Bounds: [0, 10]^2. Dimensions: n=2.
- **Levy**: Multimodal, non-convex, differentiable, separable, scalable. Minimum: 0.0 at (1, ..., 1). Bounds: [-10, 10]^n. Dimensions: Any n.
- **McCormick**: Multimodal, differentiable, non-convex, non-scalable. Minimum: -1.913222954981036 at (0.547197551196597, -1.547197551196597). Bounds: [-1.5, 4] × [-3, 4]. Dimensions: n=2.
...
- **Shekel**: Multimodal, differentiable, non-convex, non-scalable. Minimum: approximately -10.1532 for m=5, -10.4029 for m=7, -10.5364 for m=10 at (4, 4, 4, 4). Bounds: [0, 10]^4. Dimensions: n=4.
- **Shubert**: Multimodal, differentiable, non-convex, non-scalable. Minimum: -186.7309 at multiple points (e.g., (-7.0835, 4.8580)). Bounds: [-10, 10]^2. Dimensions: n=2.
- **SixHumpCamelback**: Multimodal, differentiable, non-convex, non-scalable. Minimum: -1.031628453489877 at (±0.08984201368301331, ±0.7126564032704135). Bounds: [-5, 5]^2. Dimensions: n=2.
- **Sphere**: Unimodal, convex, differentiable, separable, scalable. Minimum: 0.0 at (0, ..., 0). Bounds: [-5.12, 5.12]^n. Dimensions: Any n.
- **StyblinskiTang**: Multimodal, non-convex, differentiable, separable, scalable. Minimum: approximately -39.16599*n at (-2.903534, ..., -2.903534). Bounds: [-5, 5]^n. Dimensions: Any n.
