...
- Ackley: Multimodal, non-convex, non-separable, differentiable, scalable, bounded. Minimum: 0.0 at (0, ..., 0). Bounds: [-32.768, 32.768]^n (benchmark) or [-5, 5]^n (default). Dimensions: Any n ≥ 1.
...
- Beale: Multimodal, differentiable, non-convex. Minimum: 0.0 at (3.0, 0.5). Bounds: [-4.5, 4.5]^2. Dimensions: n=2.
- Bohachevsky: Multimodal, differentiable, non-convex, scalable. Minimum: 0.0 at (0, ..., 0). Bounds: [-10, 10]^n. Dimensions: Any n ≥ 2.
...
- Bukin6: Multimodal, differentiable, non-convex. Minimum: 0.0 at (-10.0, 1.0). Bounds: [-15, -5] × [-3, 3]. Dimensions: n=2.
...
- GoldsteinPrice: Multimodal, differentiable, non-convex, non-separable, bounded. Minimum: 3.0 at (0, -1). Bounds: [-2, 2]^2. Dimensions: n=2.
- Griewank: Multimodal, non-convex, differentiable, separable, scalable. Minimum: 0.0 at (0, ..., 0). Bounds: [-600, 600]^n. Dimensions: Any n ≥ 1.
- Hartmann: Multimodal, differentiable, non-convex, non-separable. Minimum: -3.86278214782076 at (0.114614, 0.555649, 0.852547). Bounds: [0, 1]^3. Dimensions: n=3.
- Himmelblau: Multimodal, differentiable, non-convex, bounded. Minimum: 0.0 at (3.0, 2.0), (-2.805118, 3.131312), (-3.779310, -3.283186), (3.584428, -1.848126). Bounds: [-5, 5]^2. Dimensions: n=2.
- Langermann: Multimodal, differentiable, non-convex, non-separable, bounded. Minimum: approximately -5.1621259 at (2.002992, 1.006096). Bounds: [0, 10]^2. Dimensions: n=2.
...
- McCormick: Multimodal, differentiable, non-convex. Minimum: -1.913222954981037 at (-0.547197553, -1.547197553). Bounds: [-1.5, 4] × [-3, 4]. Dimensions: n=2.
- Michalewicz: Multimodal, differentiable, non-separable, scalable, bounded. Minimum: -1.8013 (n=2), -4.687658 (n=5), -9.66015 (n=10). Bounds: [0, π]^n. Dimensions: Any n ≥ 2.
- Rana: Multimodal, differentiable, non-separable. Minimum: -498.1246382049221 at (-500.0, -499.0733193053837). Bounds: [-500, 500]^2. Dimensions: n=2.
...
- Shekel: Multimodal, differentiable, non-convex, non-separable. Minimum: -10.536409825004505 at (4.0, 4.0, 4.0, 4.0) for m=10. Bounds: [0, 10]^4. Dimensions: n=4.
- Shubert: Multimodal, differentiable, non-convex, non-separable, bounded. Minimum: -186.7309 at multiple points, e.g., (-1.4251286, -0.800321). Bounds: [-10, 10]^2. Dimensions: n=2.
- SineEnvelope: Multimodal, differentiable, non-separable. Minimum: -3.7379439163636463 at (1.538637632553666, 1.1370027579926583). Bounds: [-100, 100]^2. Dimensions: n=2.
- SixHumpCamelback: Multimodal, differentiable, non-convex, non-separable, bounded. Minimum: -1.031628453489877 at (±0.08984201368301331, ±0.7126564032704135). Bounds: [-3, 3] × [-2, 2]. Dimensions: n=2.
